...
with open('pear_result.csv', 'w') as f:
    f.write ("Pear prices, Pear Sale Date \n")
maxpage = 2

driver = webdriver.Chrome()

for i in range (1, maxpage+1):
    url = "https://agrobazar.ru/fruit/wholesale/pears/moskva_rossiya/?page=" + str(i);
    driver.get(url)
    ...
    with open ('result_pears.csv','a') as f:
